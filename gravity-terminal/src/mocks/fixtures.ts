  ...
  return {
    ...
    detail: {
      ...
      blocks: {
        methodology: {
          title: 'Methodology',
          summary: 'Component-based valuation model with cohort-relative market context.',
          components: [
          ...
          tier_methodology_version: 'tier_v2',
        },
        cohort: {
          title: 'Cohort',
          sport: a.sport ?? 'CFB',
          position_group: 'QB',
          conference: a.conference ?? 'Big 12',
        ...
        provenance: {
          title: 'Provenance',
          report_id: `${new Date().toISOString().slice(0, 10)}-${(a.name ?? 'ATH').slice(0, 2).toUpperCase()}-001`,
          rollout_phase: 'phase4',
          tier_version: 'tier_v2',
          exposure_formula_version: 'exposure_formula_v1',
          model_version: 'gravity_v1_mock',
          model_status: 'production',
        },
        shap_attribution: {
          title: 'SHAP Attribution',
          rows: [
            { feature: 'brand_reach', contribution: 0.42 },
            { feature: 'verified_deals', contribution: 0.27 },
            { feature: 'proximity_to_moments', contribution: 0.18 },
          ],
          narrative: 'Primary lift from brand reach and proof-of-performance.',
        },
      },
    },
    metadata: {
