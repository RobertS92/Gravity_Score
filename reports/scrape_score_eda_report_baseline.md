...
**Generated:** 2026-07-02 02:22 UTC

> Baseline before gap-fill run 2026-07-02T02:22:31Z.
...
|-------|--------|---------|-----|---------|---------|-----|-------------|
| cfb | 6761 | 6761 | 1.4% | 5.6% | 0.2% | 0 | 0.0% |
...
- **athlete_season_stats ≥3 but raw <3:** 204 (of 477 with ASS≥3)
...
- `(none)`: 6718 total, 3 observed
- `synthesized`: 35 total, 0 observed
